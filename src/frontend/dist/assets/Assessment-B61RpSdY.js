import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as reactDomExports, R as ReactDOM, b as cn, d as useNavigate, S as Shield } from "./index-BwP1OCSN.js";
import { B as Button } from "./button-BLTDHQjM.js";
import { P as Primitive, c as composeEventHandlers, d as dispatchDiscreteCustomEvent, u as useLayoutEffect2, a as createContextScope, b as useDirection, e as useControllableState, f as useId, g as createCollection, h as createSlot, C as ChevronDown } from "./index-BbAUpyCr.js";
import { u as useComposedRefs } from "./index-BvQBMgVo.js";
import { u as useSubmitAssessment, S as SurveyorStatus, D as DocumentStatus, R as ReportingDelay, B as BrigadeReport, F as FireCause, P as PolicyStatus } from "./backend.d-CgzjTK0-.js";
...
function mapToAssessmentInput(form) {
...
function StepSelect({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value, onValueChange: onChange, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "bg-card border-border", children: options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectItem,
      {
        value: opt.value,
...
function StepTextarea({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Textarea,
      {
...
function AssessmentPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-10 flex flex-col items-center min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 18, className: "text-secondary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-headline-sm text-primary", children: "New Assessment" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "Answer each question and add context. Your responses are sent to the server for official scoring." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl mb-6", "data-ocid": "assessment.progress", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-label text-muted-foreground", children: [
          "Step ",
          currentStep,
          " of 7 — ",
          STEP_NAMES[currentStep - 1]
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-body-sm text-secondary font-semibold", children: [
          Math.round(progressPct),
          "%"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 rounded-full bg-primary/20 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl bg-card border border-border rounded-xl shadow-elevated p-6 md:p-8 space-y-6", children: [
      currentStep === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "assessment.step1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-headline-sm text-primary mb-1", children: "Was the fire insurance policy active on the date of loss?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "Policy validity is the primary determinant of claim viability." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StepSelect,
          {
        ...
        form.step1.selection === "no" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm font-semibold text-destructive mb-1", children: "⚠️ Inactive Policy — Potentially Fatal Bar" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-destructive/80", children: "An inactive policy is a potentially fatal bar to your claim. Please describe the circumstances below — we will still analyse your full case and identify any available arguments." })
              ] })
            ]
          }
        ),
      ...
      currentStep === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "assessment.step2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-headline-sm text-primary mb-1", children: "What was the reported cause of fire?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "The stated cause affects coverage eligibility and insurer defences." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StepSelect,
          {
      ...
      currentStep === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "assessment.step3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-headline-sm text-primary mb-1", children: "Is a fire brigade report (NOC / fire report) available?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "The fire brigade report is important corroborating evidence for your claim." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StepSelect,
          {
      ...
      currentStep === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "assessment.step4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-headline-sm text-primary mb-1", children: "How many days after the fire was the insurer intimated?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "Delay in intimation is a common ground for repudiation, though courts allow reasonable explanation." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StepSelect,
          {
      ...
      currentStep === 5 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "assessment.step5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-headline-sm text-primary mb-1", children: "Are all required claim documents submitted?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "Complete documentation significantly reduces the insurer's ability to reject on procedural grounds." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StepSelect,
          {
      ...
      currentStep === 6 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "assessment.step6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-headline-sm text-primary mb-1", children: "What is the status of the insurer's surveyor report?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "The surveyor's findings heavily influence the insurer's decision, though courts can override arbitrary assessments." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StepSelect,
          {
      ...
      currentStep === 7 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "assessment.step7", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-headline-sm text-primary mb-1", children: "Any other relevant information about your claim or the insurer's response?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "Provide any additional context — repudiation reasons, legal communications, prior history, etc." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StepTextarea,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 p-3 rounded-lg bg-primary/5 border border-primary/15", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 14, className: "text-secondary mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "This context is used by the scoring engine to apply a contextual adjustment (±10 points) to your final score based on positive and negative factors identified in your narrative." })
        ] })
      ] }),
      submitError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-destructive", children: submitError })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-2 border-t border-border", children: [
        ...
        currentStep < 7 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
    ...
    isPending && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-8 flex flex-col items-center gap-4 shadow-elevated max-w-sm mx-4 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full border-4 border-primary/20 border-t-secondary animate-spin" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-lg font-semibold text-primary mb-1", children: "Analysing Your Claim" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-sm text-muted-foreground", children: "The scoring engine is evaluating your inputs against established case law and legal parameters…" })
          ] })
        ] })
      }
    )
